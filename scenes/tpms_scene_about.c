...
void tpms_scene_about_widget_callback(GuiButtonType result, InputType type,
                                      void *context) {
  TPMSApp *app = context;
...
void tpms_scene_about_on_enter(void *context) {
  ...
  widget_add_text_box_element(
      app->widget, 0, 2, 128, 14, AlignCenter, AlignBottom,
      "\e#\e!          TPMS Reader         \e!\n", false);
  ...
  for (size_t i = 0;
       i < subghz_protocol_registry_count(&tpms_protocol_registry); ++i) {
    char *frequency = NULL;
