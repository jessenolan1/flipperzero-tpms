...
static void tpms_scene_receiver_info_add_to_history_callback(
  ...
  if (tpms_history_add_to_history(app->txrx->history, decoder_base,
    ...
    tpms_view_receiver_info_update(
        ...
        tpms_history_get_raw_data(app->txrx->history,
...
void tpms_scene_receiver_info_on_enter(void *context) {
  ...
  subghz_receiver_set_rx_callback(
      app->txrx->receiver, tpms_scene_receiver_info_add_to_history_callback,
      app);
  tpms_view_receiver_info_update(
      app->tpms_receiver_info,
      tpms_history_get_raw_data(app->txrx->history,
...
void tpms_scene_receiver_info_on_exit(void *context) { UNUSED(context); }
